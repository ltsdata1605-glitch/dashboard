                            ...
                            {filteredOptions.length > 0 ? (
                                ...
                                allowCustom && searchTerm.trim() ? (
                                    <li
                                        ...
                                        className="cursor-pointer select-none relative py-2 pl-3 pr-9 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-slate-700 font-medium"
                                    >
