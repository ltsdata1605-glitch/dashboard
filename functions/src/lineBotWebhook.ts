...
function formatHelpGuideMessage(): string {
    return [
        ...
        '• "tk event" (hoặc "tk e"): Xem tồn kho PMH Event',
        '• "tk gvgs" (hoặc "tk gv"): Xem tồn kho PMH Giờ Vàng',
        '👉 Bot trả về Thẻ Flex Dashboard tương tác hiển thị số lượng & nút lấy mã.',
        '',
        '⚡ 2. XIN NHẬN MÃ COUPON (2 CÁCH):',
        '🔹 CÁCH 1: LẤY NHANH THEO SỐ (KHUYÊN DÙNG)',
        '• Nhóm Event: e[STT] [MĐH]',
        '  ➜ Ví dụ: e2 hoặc e2 00910SO26090335446',
        '• Nhóm Giờ Vàng: gv[STT] [MĐH]',
        '  ➜ Ví dụ: gv1 hoặc gv1 00910SO26090335446',
        '💡 Gõ "tk event" hoặc "tk gvgs" trước để biết số thứ tự [STT] sản phẩm!',
        '',
        '🔹 CÁCH 2: DÙNG FORM MẪU ĐĂNG KÝ',
        'FORM MẪU LẤY PMH',
        'Loại PMH: [Tên sản phẩm hoặc Model]',
        'MĐH Áp dụng: [Mã đơn hàng]',
        '  ➜ Ví dụ: Loại PMH: Bear CH-5H03P36 | MĐH: 12345678',
        '',
        '🔄 3. HƯỚNG DẪN HỦY / TRẢ MÃ VỀ KHO:',
        '• Gõ: "huy [Mã coupon]" hoặc "huy [MĐH]"',
        '  ➜ Ví dụ: huy 6W43J4BI2S hoặc huy 12345678',
        '• Hoặc gõ "huy" để xem hướng dẫn chi tiết.',
        '👉 Mã huỷ sẽ tự động hoàn lại trạng thái "Khả dụng" cho các bạn khác dùng.',
        '',
        '🎯 4. LỌC PMH CỦA BẠN (CHAT RIÊNG 1-1):',
        '• Chuyển tiếp tin nhắn gộp danh sách mã cho BOT (chat riêng 1-1).',
        '• Bot tự động lọc và trích xuất đúng các mã thuộc tên bạn.',
        '',
        '📋 5. TIỆN ÍCH HỆ THỐNG:',
        '• "id": Tra cứu LINE User ID cá nhân hoặc Group ID',
        '• Bot hoạt động 24/7 cả trong Nhóm chung lẫn Chat 1-1 riêng.',
        '━━━━━━━━━━━━━━━━━━━━━',
        '💡 Chạm trực tiếp vào khung mã coupon trên tin nhắn để TỰ ĐỘNG COPY!'
    ].join('\n');
}
