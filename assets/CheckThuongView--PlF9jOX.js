import{u as v,j as n,I as g}from"./index-BpbHRnMA.js";import{a as o}from"./vendor-ui-B11sYSIf.js";import{r as w}from"./vendor-charts-Btr9eoIt.js";import"./vendor-firebase-DvWAV7xs.js";const C=`
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
`,H=()=>{const{activeTab:u}=v(),[h,m]=o.useState(!1),a=o.useRef(null),[f,b]=o.useState(!1),[s,l]=o.useState({code1:"910",code2:""});o.useEffect(()=>{m(!0);const t=e=>{var i;((i=e.data)==null?void 0:i.type)==="CHECK_THUONG_FILE_LOADED"&&(b(!0),e.data.code1&&l(r=>({...r,code1:e.data.code1})),e.data.code2&&l(r=>({...r,code2:e.data.code2})))};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[]);const x=()=>{var t,e;(e=(t=a.current)==null?void 0:t.contentWindow)==null||e.postMessage({type:"CHECK_THUONG_SEARCH",code1:s.code1,code2:s.code2},"*")},c=(t,e)=>{l(i=>{var d,p;const r={...i,[t]:e};return(p=(d=a.current)==null?void 0:d.contentWindow)==null||p.postMessage({type:"CHECK_THUONG_SEARCH",code1:r.code1,code2:r.code2},"*"),r})},y=()=>{var t,e;(e=(t=a.current)==null?void 0:t.contentWindow)==null||e.postMessage({type:"CHECK_THUONG_CHANGE_FILE"},"*")};return n.jsxs("div",{className:"w-full h-full flex flex-col bg-white dark:bg-slate-900 absolute inset-0",children:[h&&u==="check-thuong"&&f&&document.getElementById("global-header-actions")&&w.createPortal(n.jsxs("div",{className:"flex items-center gap-2 bg-white/60 dark:bg-slate-900/60 p-1.5 rounded-full border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-xl shadow-sm animate-in fade-in zoom-in duration-300",children:[n.jsxs("div",{className:"flex items-center gap-2 px-2",children:[n.jsx("input",{type:"text",placeholder:"Mã kho (VD: 910)",className:"w-32 lg:w-40 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:s.code1,onChange:t=>c("code1",t.target.value)}),n.jsx("span",{className:"text-slate-300 dark:text-slate-600",children:"|"}),n.jsx("input",{type:"text",placeholder:"So sánh...",className:"w-28 lg:w-36 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:s.code2,onChange:t=>c("code2",t.target.value)})]}),n.jsxs("div",{className:"flex items-center gap-1 border-l border-slate-200 dark:border-slate-700 pl-2",children:[n.jsx("button",{onClick:x,className:"w-8 h-8 flex items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 transition-colors",title:"Tra cứu",children:n.jsx(g,{name:"search",size:4})}),n.jsx("button",{onClick:y,className:"w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors",title:"Tải file khác",children:n.jsx(g,{name:"upload",size:4})})]})]}),document.getElementById("global-header-actions")),n.jsx("iframe",{ref:a,srcDoc:C,title:"Bảng Tra Cứu Thưởng Thi Đua",className:"w-full h-full border-none flex-grow",style:{width:"100%",height:"100%",minHeight:"100vh",border:"none"},sandbox:"allow-scripts allow-same-origin allow-forms allow-downloads"})]})};export{H as CheckThuongView,H as default};
