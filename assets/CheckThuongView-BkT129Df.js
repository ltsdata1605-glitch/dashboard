import{u as v,j as r,I as u}from"./index-Do1Ih7S1.js";import{a as o}from"./vendor-ui-D9x1Yvee.js";import{r as w}from"./vendor-charts-h5zX1Fnb.js";import"./vendor-firebase-D_bTkCqr.js";const C=`
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
`,H=()=>{const{activeTab:g}=v(),[h,m]=o.useState(!1),a=o.useRef(null),[f,x]=o.useState(!1),[s,l]=o.useState({code1:"910",code2:""});o.useEffect(()=>{m(!0);const t=e=>{var i;((i=e.data)==null?void 0:i.type)==="CHECK_THUONG_FILE_LOADED"&&(x(!0),e.data.code1&&l(n=>({...n,code1:e.data.code1})),e.data.code2&&l(n=>({...n,code2:e.data.code2})))};return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[]);const b=()=>{var t,e;(e=(t=a.current)==null?void 0:t.contentWindow)==null||e.postMessage({type:"CHECK_THUONG_SEARCH",code1:s.code1,code2:s.code2},"*")},c=(t,e)=>{l(i=>{var d,p;const n={...i,[t]:e};return(p=(d=a.current)==null?void 0:d.contentWindow)==null||p.postMessage({type:"CHECK_THUONG_SEARCH",code1:n.code1,code2:n.code2},"*"),n})},y=()=>{var t,e;(e=(t=a.current)==null?void 0:t.contentWindow)==null||e.postMessage({type:"CHECK_THUONG_CHANGE_FILE"},"*")};return r.jsxs("div",{className:"w-full h-full flex flex-col bg-white dark:bg-slate-900 absolute inset-0",children:[h&&g==="check-thuong"&&f&&document.getElementById("global-header-actions")&&w.createPortal(r.jsxs("div",{className:"hidden lg:flex items-center gap-2 bg-white/60 dark:bg-slate-900/60 p-1.5 rounded-full border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-xl shadow-sm animate-in fade-in zoom-in duration-300",children:[r.jsxs("div",{className:"flex items-center gap-2 px-2",children:[r.jsx("input",{type:"text",placeholder:"Mã kho (VD: 910)",className:"w-32 lg:w-40 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:s.code1,onChange:t=>c("code1",t.target.value)}),r.jsx("span",{className:"text-slate-300 dark:text-slate-600",children:"|"}),r.jsx("input",{type:"text",placeholder:"So sánh...",className:"w-28 lg:w-36 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:s.code2,onChange:t=>c("code2",t.target.value)})]}),r.jsxs("div",{className:"flex items-center gap-1 border-l border-slate-200 dark:border-slate-700 pl-2",children:[r.jsx("button",{onClick:b,className:"w-8 h-8 flex items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 transition-colors",title:"Tra cứu",children:r.jsx(u,{name:"search",size:4})}),r.jsx("button",{onClick:y,className:"w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors",title:"Tải file khác",children:r.jsx(u,{name:"upload",size:4})})]})]}),document.getElementById("global-header-actions")),r.jsx("iframe",{ref:a,srcDoc:C,title:"Bảng Tra Cứu Thưởng Thi Đua",className:"w-full h-full border-none flex-grow",style:{width:"100%",height:"100%",minHeight:"100vh",border:"none"},sandbox:"allow-scripts allow-same-origin allow-forms allow-downloads"})]})};export{H as CheckThuongView,H as default};
