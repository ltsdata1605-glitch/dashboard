import{u as y,j as t,I as s}from"./index-BMfHH2Q7.js";import{a as d}from"./vendor-ui-B9PAsar3.js";import{r as v}from"./vendor-charts-NOCJZyOI.js";import"./vendor-firebase-Bg-CYcPW.js";const w=`
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
`,T=()=>{const{activeTab:m}=y(),[f,x]=d.useState(!1),i=d.useRef(null),[p,b]=d.useState(!1),[a,l]=d.useState({code1:"910",code2:""});d.useEffect(()=>{x(!0);const e=r=>{var n;((n=r.data)==null?void 0:n.type)==="CHECK_THUONG_FILE_LOADED"&&(b(!0),r.data.code1&&l(o=>({...o,code1:r.data.code1})),r.data.code2&&l(o=>({...o,code2:r.data.code2})))};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[]);const c=(e,r)=>{l(n=>{var g,h;const o={...n,[e]:r};return(h=(g=i.current)==null?void 0:g.contentWindow)==null||h.postMessage({type:"CHECK_THUONG_SEARCH",code1:o.code1,code2:o.code2},"*"),o})},u=()=>{var e,r;(r=(e=i.current)==null?void 0:e.contentWindow)==null||r.postMessage({type:"CHECK_THUONG_CHANGE_FILE"},"*")};return t.jsxs("div",{className:"w-full h-full flex flex-col bg-white dark:bg-slate-900 absolute inset-0",children:[f&&m==="check-thuong"&&p&&document.getElementById("global-header-actions")&&v.createPortal(t.jsxs("div",{className:"hidden lg:flex items-center gap-2 bg-white/60 dark:bg-slate-900/60 p-1.5 rounded-full border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-xl shadow-sm animate-in fade-in zoom-in duration-300",children:[t.jsxs("div",{className:"flex items-center gap-2 px-2",children:[t.jsx("input",{type:"text",placeholder:"Mã kho (VD: 910)",className:"w-32 lg:w-40 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:a.code1,onChange:e=>c("code1",e.target.value)}),t.jsx("span",{className:"text-slate-300 dark:text-slate-600",children:"|"}),t.jsx("input",{type:"text",placeholder:"So sánh...",className:"w-28 lg:w-36 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)]",value:a.code2,onChange:e=>c("code2",e.target.value)})]}),t.jsxs("div",{className:"flex items-center gap-1 border-l border-slate-200 dark:border-slate-700 pl-2",children:[t.jsx("button",{onClick:()=>{var e,r;l(n=>({...n,code2:""})),(r=(e=i.current)==null?void 0:e.contentWindow)==null||r.postMessage({type:"CHECK_THUONG_SEARCH",code1:a.code1,code2:""},"*")},className:"w-8 h-8 flex items-center justify-center rounded-full bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/40 text-red-500 dark:text-red-400 transition-colors",title:"Xoá mã kho đang so sánh",children:t.jsx(s,{name:"rotate-ccw",size:4})}),t.jsx("button",{onClick:u,className:"w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 transition-colors",title:"Tải file khác",children:t.jsx(s,{name:"upload",size:4})})]})]}),document.getElementById("global-header-actions")),p&&t.jsxs("div",{className:"lg:hidden sticky top-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/60 dark:border-slate-700/60 px-3 py-2 flex items-center gap-2",children:[t.jsxs("div",{className:"flex items-center gap-2 flex-1",children:[t.jsxs("div",{className:"relative flex-1",children:[t.jsx("div",{className:"absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none text-slate-400",children:t.jsx(s,{name:"search",size:3.5})}),t.jsx("input",{type:"text",placeholder:"Mã kho (VD: 910)",className:"w-full h-9 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md pl-8 pr-3 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 transition-all",value:a.code1,onChange:e=>c("code1",e.target.value)})]}),t.jsxs("div",{className:"relative flex-1",children:[t.jsx("div",{className:"absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none text-slate-400",children:t.jsx(s,{name:"arrow-left-right",size:3.5})}),t.jsx("input",{type:"text",placeholder:"So sánh...",className:"w-full h-9 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md pl-8 pr-3 text-sm font-semibold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 transition-all",value:a.code2,onChange:e=>c("code2",e.target.value)})]})]}),t.jsx("button",{onClick:()=>{var e,r;l(n=>({...n,code2:""})),(r=(e=i.current)==null?void 0:e.contentWindow)==null||r.postMessage({type:"CHECK_THUONG_SEARCH",code1:a.code1,code2:""},"*")},className:"h-9 px-3 bg-red-50 text-red-500 rounded-md flex items-center gap-1.5 text-xs font-semibold hover:bg-red-100 transition-colors shrink-0",title:"Xoá mã kho",children:t.jsx(s,{name:"rotate-ccw",size:3.5})}),t.jsx("button",{onClick:u,className:"h-9 px-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 rounded-md flex items-center hover:bg-slate-200 transition-colors shrink-0",title:"Tải file khác",children:t.jsx(s,{name:"upload",size:3.5})})]}),t.jsx("iframe",{ref:i,srcDoc:w,title:"Bảng Tra Cứu Thưởng Thi Đua",className:"w-full h-full border-none flex-grow",style:{width:"100%",height:"100%",minHeight:"100vh",border:"none"},sandbox:"allow-scripts allow-same-origin allow-forms allow-downloads"})]})};export{T as CheckThuongView,T as default};
