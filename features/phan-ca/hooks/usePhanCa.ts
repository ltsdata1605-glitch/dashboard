...
export const usePhanCa = () => {
  ...
  return { mounted, activeTab, handleImportClick, handleDeleteStaffList, setEditPatternModalOpen, handleExportAll, hasStaff, handleExportWeekly, handleExportIndividual, handleExportExcel, handleExportGoogleSheet, isExportingImage, monthYear, setMonthYear, startDay, setStartDay, duration, setDuration, handleGenerateClick, uniqueDepartments, departmentFilter, setDepartmentFilter, supermarkets, currentSupermarket, handleSupermarketChange, onboardingStep, departmentPatterns, handleDateControlClick, exportContainerRef, isIndividualExport, exportTitle, setHistoryModalOpen, targets, handleEditRule, includeTnInSbh, setIncludeTnInSbh, autoAddWeekendShifts, handleAutoAddWeekendShiftsChange, autoAddWeekendShift1, handleAutoAddWeekendShift1Change, staffList, scheduleConfig, dailyRequirements, setDailyRequirements, statsDay, setStatsDay, unresolvedConflicts, handleShowConflicts, listForTable, tableRef, handleDeleteEmployee, handleEditShift, handleDayHover, hoveredDay, weeklyExportConfig, currentHighlightedId, handleSwapShifts, fileInputRef, handleFileChange, isEditRulesModalOpen, editingRuleKey, rules, setRules, setEditRulesModalOpen, generateNewSchedule, isEditPatternModalOpen, setDepartmentPatterns, staffCountByDept, shiftDefinitions, setShiftDefinitions, isImportModalOpen, importedStaff, setImportModalOpen, handleConfirmImport, isEditShiftModalOpen, editingCellInfo, setEditShiftModalOpen, handleSaveShift, busySchedule, isHistoryModalOpen, scheduleHistory, isConflictModalOpen, setConflictModalOpen, isDeleteConfirmOpen, confirmDeleteStaffList, setIsDeleteConfirmOpen, confirmDialog, closeConfirm, batchExportProgress };
};
