...
export const CheckThuongSummaryCards: React.FC<CheckThuongSummaryCardsProps> = ({
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3 mb-3">
            {/* THẺ 1: TỔNG SIÊU THỊ */}
            <div className="relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-2.5 sm:p-3 shadow-2xs hover:shadow-xs transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between">
                    <span className="text-[10px] sm:text-[10.5px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                        Tổng Siêu Thị
                    </span>
                    <div className="w-5 h-5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 flex items-center justify-center shrink-0">
            ...
            <div
                className="relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-2.5 sm:p-3 shadow-2xs hover:shadow-xs transition-all flex flex-col justify-between"
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <div className="w-5 h-5 rounded-md bg-slate-100 dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0">
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <span className="px-1.5 py-0.2 text-[9px] font-black uppercase rounded-sm bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                        TOP 1
                    </span>
                </div>
            ...
            <div className="relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-2.5 sm:p-3 shadow-2xs hover:shadow-xs transition-all flex flex-col justify-between">
                <div className="flex items-center justify-between">
                    ...
                    <div className="w-5 h-5 rounded-md bg-slate-100 dark:bg-slate-800 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
