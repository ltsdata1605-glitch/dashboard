                                ...
                                <thead>
                                    <tr className="text-[11px] font-black uppercase tracking-wider">
                                        ...
                                        <th 
                                            ...
                                            className="px-1.5 py-1.5 text-center border-r border-slate-200 dark:border-slate-700 border-b-[3px] border-b-rose-400 bg-rose-50 dark:bg-rose-950/30 text-rose-700 dark:text-rose-400 min-w-[55px] leading-tight align-middle cursor-pointer hover:bg-rose-100 dark:hover:bg-rose-900/50 transition-all"
                                        >
                                            <div className="flex items-center justify-center gap-1">
                                                <span>BOT</span>
                                        ...
                                        <th 
                                            ...
                                            className="px-1.5 py-1.5 text-center border-r border-slate-200 dark:border-slate-700 border-b-[3px] border-b-rose-400 bg-rose-100 dark:bg-rose-900/40 text-rose-800 dark:text-rose-300 min-w-[60px] leading-tight align-middle cursor-pointer hover:bg-rose-200 dark:hover:bg-rose-900/60 transition-all"
                                        >
                                            <div className="flex items-center justify-center gap-1">
                                                <span>NoSale</span>
