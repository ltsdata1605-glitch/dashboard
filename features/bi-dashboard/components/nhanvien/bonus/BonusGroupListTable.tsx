        ...
        <table className="w-full border-collapse compact-export-table">
            <thead className="sticky top-0 z-10">
                ...
                <tr>
                    ...
                    <th className="border-l-2 border-l-slate-300 dark:border-l-slate-600 px-1.5 py-1 text-center text-[11px] font-black uppercase tracking-wider text-blue-700 dark:text-blue-400 bg-blue-50/60 dark:bg-blue-950/40 border-r border-b border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-blue-100/70 transition-colors" onClick={() => { setSortField('erp'); setSortDir(d => d === 'asc' ? 'desc' : 'asc'); }}>ERP {sortField === 'erp' ? (sortDir === 'asc' ? '↑' : '↓') : ''}</th>
                    <th className="px-1.5 py-1 text-center text-[11px] font-black uppercase tracking-wider text-orange-700 dark:text-orange-400 bg-orange-50/60 dark:bg-orange-950/40 border-r border-b border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-orange-100/70 transition-colors" onClick={() => { setSortField('tNong'); setSortDir(d => d === 'asc' ? 'desc' : 'asc'); }}>T.Nóng {sortField === 'tNong' ? (sortDir === 'asc' ? '↑' : '↓') : ''}</th>
