                        ...
                        {isMobile ? (
                            ...
                            <table className="w-full border-collapse border border-slate-200 dark:border-slate-700">
                                <thead className="sticky top-0 z-10">
                                    ...
                                    {/* Tier 2: Column Headers - only shown when % columns visible — nền/màu trung tính, tier 1 đã đủ để phân nhóm */}
                                    {!hidePercent && <tr className="bg-slate-50 dark:bg-slate-800/80">
                                        {providers.map(p => <React.Fragment key={p.name}><th className="px-1 py-1 text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 border-r border-b-2 border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 transition-colors">DT</th><th className="px-1 py-1 text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 border-r border-b-2 border-slate-200 dark:border-slate-700 cursor-pointer hover:bg-slate-100 transition-colors">%</th></React.Fragment>)}
                                    </tr>}
                                </thead>
