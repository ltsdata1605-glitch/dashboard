                    ...
                    <div className="flex items-start gap-2.5">
                        ...
                        <div className="text-xs space-y-1">
                            ...
                            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                                <strong className="text-emerald-700 dark:text-emerald-300">Auto Click+</strong> sẽ tự động kiểm tra và mở tất cả các dấu <code className="px-1 py-0.5 bg-white dark:bg-slate-800 rounded font-bold text-emerald-600 dark:text-emerald-400 border border-slate-200 dark:border-slate-700">[+]</code> nếu có, sau đó tự động sao chép toàn bộ trang theo chuẩn <strong className="text-slate-800 dark:text-slate-200">CopyAll</strong> vào Clipboard. Dữ liệu sao chép đảm bảo trọn vẹn 38 chương trình thi đua & ngành hàng, không bao giờ bị thiếu!
                            </p>
                        </div>
                    </div>
                </div>
