...
export const CompetitionKpiCards: React.FC<CompetitionKpiCardsProps> = ({
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5 mb-3 sm:mb-4 px-1.5 sm:px-2 lg:px-6">
            ...
            <div 
                className="relative bg-white dark:bg-slate-800/90 rounded-xl p-3 sm:p-3.5 border border-slate-200/80 dark:border-slate-700 shadow-xs hover:shadow-md transition-shadow overflow-hidden flex flex-col justify-between"
            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 mb-1.5">
                    ...
                    <div className="w-6 h-6 rounded-md bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0 border border-emerald-200/60 dark:border-emerald-800/60">
            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 mb-1.5">
                    ...
                    <div className="w-6 h-6 rounded-md bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0 border border-rose-200/60 dark:border-rose-800/60">
            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 mb-1.5">
                    ...
                    <div className="w-6 h-6 rounded-md bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 border border-amber-200/60 dark:border-amber-800/60">
            ...
            >
                ...
                <div className="flex items-center justify-between gap-2 mb-1.5">
                    ...
                    <div className="w-6 h-6 rounded-md bg-slate-100 dark:bg-slate-700/50 text-slate-500 dark:text-slate-400 flex items-center justify-center shrink-0 border border-slate-200/60 dark:border-slate-600/60">
                        <XCircle className="w-3.5 h-3.5" />
                    </div>
                </div>

                <div className="flex items-baseline gap-1.5 mb-1">
                    <span className="text-2xl sm:text-3xl font-black text-slate-700 dark:text-slate-300 tabular-nums">
                        {stats.countZero}
                    </span>
                    <span className="text-xs font-bold text-slate-400">nhóm</span>
                </div>
