...
const FilterBar: React.FC<FilterBarProps> = ({ onToggleAdvanced, onNewFile }) => {
    ...
    return (
        <div className="w-full mb-4 z-[90] lg:z-[100] sticky top-[44px] lg:top-1.5 hide-on-export">
            <div className="bg-white dark:bg-slate-900 border-y sm:border border-slate-200/80 dark:border-slate-700/60 rounded-none sm:rounded-xl lg:rounded-full shadow-sm p-1.5 lg:px-3 lg:py-2 transition-all">
