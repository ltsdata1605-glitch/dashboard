...
export default function AboutView() {
    return (
        <div className="p-3 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 pb-32 animate-in fade-in duration-500 max-w-7xl mx-auto">
            {/* Hero Section */}
            <div className="relative overflow-hidden rounded-lg sm:rounded-3xl bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-800 p-5 sm:p-8 text-white shadow-xl">
                ...
                <div className="relative z-10 max-w-3xl">
                    ...
                    <h1 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-3 tracking-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-indigo-200">
                        Dashboard YCX
                        <br />
                        Bảo Mật Tuyệt Đối
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <div className="bg-white dark:bg-slate-800 rounded-lg p-4 sm:p-6 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 mb-3 sm:mb-4">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg p-4 sm:p-6 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-lg bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 mb-3 sm:mb-4">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg p-4 sm:p-6 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-lg bg-rose-50 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 mb-3 sm:mb-4">
            ...
            {/* Feature Breakdown */}
            <h2 className="text-xl sm:text-2xl font-bold text-slate-800 dark:text-white pt-2 sm:pt-4 flex items-center gap-2 sm:gap-3">
