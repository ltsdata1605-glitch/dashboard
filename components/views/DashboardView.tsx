        ...
        <div className="w-full">
            ...
            {pendingRequestsCount > 0 && (
                <div 
                    ...
                    className="w-full bg-indigo-600 dark:bg-indigo-900 border-b border-indigo-500/50 cursor-pointer overflow-hidden z-20 flex items-center shadow-lg shadow-indigo-500/20 group transition-all"
                >
