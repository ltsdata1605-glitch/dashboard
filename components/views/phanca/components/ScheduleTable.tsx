                    ...
                    <>
                        ...
                        <td className="sticky-col text-left px-4 border-r border-slate-200 text-[11px] font-semibold bg-white" style={{ left: '40px' }}>
                            <div className="flex justify-between items-center">
                                ...
                                <button onClick={() => onDeleteEmployee(staff.id)} className="opacity-0 group-hover:opacity-100 p-1 text-slate-300 hover:text-rose-600 transition-all export-hidden">
