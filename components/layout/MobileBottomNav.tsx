...
const MobileBottomNav: React.FC = React.memo(() => {
    ...
    const moreTabs = [
        ...
        { id: 'reports', label: 'Báo cáo', icon: FileText, externalUrl: 'https://forms.gle/yBs44xCdCVDN5dPeA' },
    ...
    return (
        <>
            ...
            {/* Bottom Tab Bar */}
            <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-[190] bg-white dark:bg-slate-900 pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
