...
export const SectionHeader: React.FC<SectionHeaderProps> = ({ title, icon, subtitle, children }) => {
    return (
        <div className="px-3 py-2 lg:px-4 lg:py-2.5 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-1.5 lg:gap-0 border-b border-slate-100 dark:border-slate-800 lg:border-b-slate-100 lg:dark:border-b-slate-800" style={{ borderImage: 'linear-gradient(to right, rgba(99,102,241,0.15), rgba(14,165,233,0.1), transparent) 1' }}>
            <div className="flex items-center gap-2 lg:gap-3 min-w-0">
                ...
                <div className="min-w-0">
                    ...
                    {subtitle && <div className="text-[10px] lg:text-[11px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-0.5 truncate">{subtitle}</div>}
                </div>
            </div>
