...
import {
  ...
  Link, List, ListTodo, Loader2, LogOut, MapPin, Maximize2, Medal, Megaphone, MemoryStick, MessageCircle, MoreVertical,
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  'lightbulb': Lightbulb, 'link': Link, 'list': List, 'list-todo': ListTodo,
