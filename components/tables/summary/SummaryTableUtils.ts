...
export const HEADER_CONFIG = [
    { label: 'S.LƯỢNG', key: 'totalQuantity', showInComparison: true, colorClass: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400', borderColor: 'border-emerald-200 dark:border-emerald-500/20' },
    { label: 'D.THU', key: 'totalRevenue', showInComparison: true, colorClass: 'bg-sky-50 text-sky-700 dark:bg-sky-500/10 dark:text-sky-400', borderColor: 'border-sky-200 dark:border-sky-500/20' },
    { label: 'DTQĐ', key: 'totalRevenueQD', showInComparison: true, colorClass: 'bg-teal-50 text-teal-700 dark:bg-teal-500/10 dark:text-teal-400', borderColor: 'border-teal-200 dark:border-teal-500/20' },
    { label: 'GTĐH', key: 'aov', showInComparison: true, colorClass: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-400', borderColor: 'border-indigo-200 dark:border-indigo-500/20' },
    { label: '% T.Chậm', key: 'traGopPercent', showInComparison: true, colorClass: 'bg-cyan-50 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-400', borderColor: 'border-cyan-200 dark:border-cyan-500/20' },
];
