...
const HEADER_CONFIG = [
    ...
    { label: 'DTQĐ', key: 'totalRevenueQD', showInComparison: true, colorClass: 'bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400', borderColor: 'border-primary-200 dark:border-primary-500/20' },
...
const PILL_COLORS: Record<string, string> = {
    ...
    'manufacturer': 'bg-primary-100 text-primary-800 border-primary-300 dark:bg-primary-900/40 dark:text-primary-200 dark:border-primary-700',
...
const SummaryTable: React.FC<SummaryTableProps> = React.memo(() => {
    ...
    return (
        <>
            <div className="bg-white dark:bg-slate-900 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 dark:border-slate-800 overflow-hidden rounded-none mb-8 transition-all duration-300" ref={tableContainerRef}> 
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-xl bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400 flex items-center justify-center shadow-sm">
                  ...
                  <table className="min-w-full compact-export-table border-collapse" id="summary-table">
                      ...
                      <thead>
                        {isComparisonMode ? (
                            ...
                            <tr>
                                <th scope="col" className={`px-4 py-2 text-left uppercase text-sm font-bold tracking-wider text-primary-800 dark:text-primary-200 border-b-4 border-primary-100 bg-primary-50 sticky left-0 z-40 dark:bg-slate-900 ${separatorClass}`}>DANH MỤC</th>
                       ...
                       <tbody>
                        ...
                        {/* FOOTER */}
                        <tfoot className="bg-primary-50 dark:bg-primary-900/50 font-extrabold text-base border-t-2 border-slate-300 dark:border-slate-600">
                           <tr>
                                <td className={`px-4 py-2 text-center sticky left-0 z-40 bg-primary-50 dark:bg-primary-900/50 ${separatorClass}`}>TỔNG CỘNG</td>
                                {/* Quantity */}
                                ...
                                {/* RevenueQD */}
                                <td className={`${footerCellClass} text-primary-700 dark:text-primary-300 ${!isComparisonMode ? separatorClass : ''}`}>{formatCurrency(grandTotal.totalRevenueQD)}</td>
