                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-bold uppercase tracking-widest text-amber-700 dark:text-amber-400 flex items-center gap-1.5">
                            <span className="bg-amber-100 dark:bg-amber-950 px-1.5 py-0.5 rounded text-[11px] font-black text-amber-700 dark:text-amber-300">BẮT BUỘC</span>
                            Đặt tên hiển thị
                        </h3>
                        ...
                        <div className="flex flex-col gap-2">
                            {suggestions.map((suggestion, idx) => (
                                ...
                                >
                                    ...
                                    <span className="text-[11px] text-slate-400 group-hover:text-amber-500 transition-colors uppercase font-bold shrink-0">Áp dụng</span>
                                </Button>
                            ))}
                        </div>
                    </div>
