        ...
        >
            <div className="flex flex-col p-6 space-y-5">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 flex items-center justify-center border border-amber-100/50 dark:border-amber-900/20 shrink-0">
                    ...
                    <div>
                        <h3 className="text-sm font-bold uppercase tracking-widest text-amber-600 dark:text-amber-400 flex items-center gap-1.5">
                            <span className="bg-amber-100 dark:bg-amber-950 px-1.5 py-0.5 rounded text-[10px] font-bold text-amber-700 dark:text-amber-300">BẮT BUỘC</span>
                            Đặt tên hiển thị
                        </h3>
                ...
                <form onSubmit={handleConfirm} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full h-11 px-3.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 rounded-lg text-slate-800 dark:text-white placeholder:text-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all font-semibold"
                        />
                    </div>
                    ...
                    <div className="pt-2">
                        <button
                            ...
                            className="w-full h-11 bg-amber-600 hover:bg-amber-500 disabled:opacity-40 disabled:hover:bg-amber-600 text-white font-bold uppercase tracking-widest text-xs rounded-lg shadow-md shadow-amber-500/10 active:scale-[0.98] transition-all disabled:pointer-events-none flex items-center justify-center gap-1.5"
                        >
