        ...
        <div ref={ref}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             {(analysis || isAnalysisLoading) && (
                <div className="mt-4 p-4 bg-primary-50 dark:bg-slate-900/50 border border-primary-200 dark:border-primary-900/50 rounded-lg">
                    <h4 className="font-bold text-primary-800 dark:text-primary-200 flex items-center gap-2">
                        <Icon name="sparkles" />
                        AI Phân Tích 7 Ngày
                    </h4>
                    {isAnalysisLoading ? (
