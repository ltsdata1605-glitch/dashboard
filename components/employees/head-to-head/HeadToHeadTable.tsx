...
const HeadToHeadTable: React.FC<HeadToHeadTableProps> = React.memo(({ 
    ...
    return (
        <div ref={tableRef} className="bg-white dark:bg-slate-900 border-y lg:border border-slate-200 dark:border-slate-700 rounded-none overflow-hidden flex flex-col h-full shadow-sm lg:hover:shadow-md transition-shadow">
