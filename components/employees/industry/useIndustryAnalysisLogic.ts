...
export const useIndustryAnalysisLogic = (data: ExploitationData[], baseFilteredData?: DataRow[], productConfig?: ProductConfig, customExploitationTabs?: CustomExploitationTabConfig[], efficiencyExploitationTabs?: CustomExploitationTabConfig[]) => {
    ...
    const dynamicQuickFilters = useMemo(() => {
        ...
        const pastelColors = [
            ...
            { bg: 'bg-sky-100 dark:bg-sky-500/20', text: 'text-sky-800 dark:text-sky-300' },
            ...
            { bg: 'bg-indigo-100 dark:bg-indigo-500/20', text: 'text-indigo-800 dark:text-indigo-300' },
            { bg: 'bg-slate-200 dark:bg-slate-600/40', text: 'text-slate-700 dark:text-slate-200' },
            { bg: 'bg-sky-50 dark:bg-sky-500/10', text: 'text-sky-700 dark:text-sky-400' },
            { bg: 'bg-emerald-50 dark:bg-emerald-500/10', text: 'text-emerald-700 dark:text-emerald-400' }
        ];
