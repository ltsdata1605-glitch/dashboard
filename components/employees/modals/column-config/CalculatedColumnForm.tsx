                ...
                <div className="pt-2 flex flex-wrap justify-end gap-4">
                    <div className="w-full sm:w-[220px]">
                        ...
                        <div className="flex rounded-md p-1 bg-slate-100/50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-700 w-full">
                            <Button type="button" variant="unstyled" size="none" onClick={() => setDecimalPlaces(0)} className={`flex-1 py-1.5 px-2 text-xs sm:text-sm rounded transition-colors ${decimalPlaces === 0 ? 'bg-white text-slate-800 shadow-sm border border-slate-200 font-medium' : 'text-slate-500 hover:text-slate-800 font-normal border border-transparent'}`}>Bỏ số lẻ</Button>
                            <Button type="button" variant="unstyled" size="none" onClick={() => setDecimalPlaces(1)} className={`flex-1 py-1.5 px-2 text-xs sm:text-sm rounded transition-colors ${decimalPlaces === 1 ? 'bg-white text-slate-800 shadow-sm border border-slate-200 font-medium' : 'text-slate-500 hover:text-slate-800 font-normal border border-transparent'}`}>1 chữ số</Button>
                            <Button type="button" variant="unstyled" size="none" onClick={() => setDecimalPlaces(2)} className={`flex-1 py-1.5 px-2 text-xs sm:text-sm rounded transition-colors ${decimalPlaces === 2 ? 'bg-white text-slate-800 shadow-sm border border-slate-200 font-medium' : 'text-slate-500 hover:text-slate-800 font-normal border border-transparent'}`}>2 chữ số</Button>
                        </div>
                    </div>
                    {operation === '/' && (
                        <div className="w-full sm:w-[140px]">
                            ...
                            <div className="flex rounded-md p-1 bg-slate-100/50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-700 w-full">
                                <Button type="button" variant="unstyled" size="none" onClick={() => setDisplayAs('number')} className={`flex-1 py-1.5 px-2 text-xs sm:text-sm rounded transition-colors ${displayAs === 'number' ? 'bg-white text-slate-800 shadow-sm border border-slate-200 font-medium' : 'text-slate-500 hover:text-slate-800 font-normal border border-transparent'}`}>Số</Button>
                                <Button type="button" variant="unstyled" size="none" onClick={() => setDisplayAs('percentage')} className={`flex-1 py-1.5 px-2 text-xs sm:text-sm rounded transition-colors ${displayAs === 'percentage' ? 'bg-white text-slate-800 shadow-sm border border-slate-200 font-medium' : 'text-slate-500 hover:text-slate-800 font-normal border border-transparent'}`}>%</Button>
                            </div>
                        </div>
                    )}
                </div>
